"""Build ppconstants as an importable CPython extension module.

Produces `ppconstants_native.<ext-suffix>` in the repository root: a real
...
Only the @vectorize kernels appear in the extension; scalar constants are
served by the pure-Python package (they are compile-time values, not
runtime symbols — see ROADMAP "Upstream request backlog").
"""
